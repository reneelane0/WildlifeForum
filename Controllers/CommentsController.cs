...
namespace WildlifeForum.Controllers
{
    public class CommentsController : Controller
    {
        private readonly WildlifeForumContext _context;

        public CommentsController(WildlifeForumContext context)
        {
            _context = context;
        }
        ...
        {
            var wildlifeForumContext = _context.Comment.Include(c => c.Discussion);
            return View(await wildlifeForumContext.ToListAsync());
        }
